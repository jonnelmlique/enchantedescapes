...
<body>
    ...
    $countQuery = "SELECT COUNT(*) AS total_purchase FROM orders_stock_view";
    $resultCount = $conn->query($countQuery);

    $totalPurchase = 0;
    if ($resultCount->num_rows > 0) {
        $row = $resultCount->fetch_assoc();
        $totalPurchase = $row["total_purchase"];
    }
    ...
    <div class="navbar">
        ...
        <a href="#" class="nav-link dashboard active" data-index="1"><img src="images/dashboard.png"
                class="icondashboard"> Dashboard</a>
        <a href="#" class="nav-link manage-product" data-index="2"><img src="images/manageproduct.png"
                class="iconmanageproduct"> Manage Product</a>
        <a href="#" class="nav-link manage-stocks" data-index="3"><img src="images/managestocks.png"
                class="iconmanagestocks"> Manage Stocks</a>
        <a href="#" class="nav-link stock-reports" data-index="4"><img src="images/reports.png"
                class="iconstockreports"> Stock Reports</a>
        <a href="#" class="nav-link suppliers" data-index="5"><img src="images/suppliers.png"
                class="iconsuppliers">Suppliers</a>
        <a href="#" class="nav-link sales-reports" data-index="6"><img src="images/reports.png"
                class="iconsalesreports">Purchase Projection</a>
    </div>

    <div class="upper-div">
        <span class="hamburger">&#9776;</span>
        <p id="datetime" class="datetime"></p>
        <p class="name-admin"> <?php echo $_SESSION['adminName']; ?></p>
        <form id="logoutForm" action="login.html" method="post" class="form2">
            <button type="button" class="logout-button" onclick="confirmLogout()"><i
    ...
    <div id="content1" class="content" style="display: block;">
        <div class="for-img">
            <div class="stocks-box"> <img src="images/managestocks.png">
                <p><?php if ($resultcountstock->num_rows > 0) {
                    $row = $resultcountstock->fetch_assoc();
                    echo "<p>" . $row["totalstock"] . "</p>";
                } else {
                    echo "<p>" . "0" . "</p>";
                } ?> <span class="stock">Stocks</span>
            </div>
            <div class="products-box"><img src="images/manageproduct.png">
                <p><?php if ($resultcountproduct->num_rows > 0) {
            ...
            <div class="critical-box">
                ...
                <p>
                    <?php
                    if ($resultcritical->num_rows > 0) {
                        $row = mysqli_fetch_assoc($resultcritical);
                        echo $row["count_less_than_20"];
                    } else {
                        echo "0";
                    }
                    ?>
                </p>
                <span class="critical">Critical Stocks</span>
            </div>

            <div class="suppliers-box"><img src="images/suppliers.png">
                <p><?php if ($resultcountsupplier->num_rows > 0) {
            ...
            <div class="totalpurchase-box"><img src="images/checklist.png">
                <p> <?php echo $totalPurchase; ?> </p><span class="purchase">Total Purchase</span>
            </div>
        </div>
        ...
        <div class="history-purchased">
            ...
            <div class="table-container">
                <!-- Wrap the table body with a container -->
                <table border="1" width="100%" class="content1-table">
                    <thead>
                        <tr>
                            <th>Order ID</th>
                            <th>Stock ID</th>
                    ...
                    <tbody>
                        <?php
                        $result = $conn->query("SELECT * FROM orders_stock_view");
        ...
        <div class="popup-form-container" id="popupFormContainer">
            <div class="popup-form">
                ...
                <form id="addProductForm" method="post" action="add_product.php">
                    ...
                    <label for="qtyperitem" class="lblqtyperitem">Total Quantity</label>
    ...
    <div id="content5" class="content">
        ...
        <div id="modal-overlaysupplier" class="modal-overlay">
            ...
            <div id="popup-formsupplier" class="popup-form">
                <form id="update-form" action="update_supplier.php" method="post" class="popup-form-content">
                    <h2>Edit Stock Information</h2>
                    <!-- Close button -->
                    ...
                    <input type="text" name="supplier_name" class="content2-productname" id="supplier-suppliername"
                        readonly>

                    <label for="address" class="lbladdress">Address</label>
                    <textarea name="address" class="address" id="supplier_address" rows="4" cols="50"
                        required></textarea>
                    ...
                    <input type="text" class="supplier-contact" id="supplier-contact" name="phone_number"
                        onkeypress="return onlyNumberKey(event)" maxlength="11" required>
