    ...
    <div class="main p-3">
        <div class="text-center">
            <div class="container">
                ...
                ?>
                <nav class="navbar justify-content-center fs-3 mb-3" style="background-color:#808080;">Employee Attendance</nav>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <a href="show-employeeinfo.php?id=<?php echo $row["Id"]; ?>" class="link-dark"><i class="fa-regular fa-eye fs-5"></i></a>
                                    <a href="update-employeeinfo.php?id=<?php echo $row["Id"]; ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                    <a href="remove.php?id=<?php echo $row["Id"]; ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
