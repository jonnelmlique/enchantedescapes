                                              ...
                                              <div class='container-3'>
                                                  ...
                                                  <div class='info-4'>
                                                      <div class='sign'>
                                                        ...
                                                        <p style='font-family: Dancing Script'>Hotel</p>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: black;">
  <a class="navbar-brand" href="#"><img src="loogo.png" width="50px"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="id.php">ID <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
  ...
  <div class="col-sm-6">
    <div class="card jumbotron">
      <div class="card-body">
        ...
        <br>
        <button class="btn btn-outline-warning my-2 my-sm-0" type="submit" name="search">Generate</button>
        </form>
      </div>
    </div>
  </div>
...
<hr>
<button id="demo" class="downloadtable btn btn-dark" onclick="downloadtable()"> Download Id Card</button>
    <!-- Optional JavaScript -->
