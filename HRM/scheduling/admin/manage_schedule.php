				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<select name="schedule_type" id="" class="custom-select">
							<option value="1" <?php echo isset($schedule_type) && $schedule_type == 1 ? 'selected' : ''  ?>>Morning Shift</option>
							<option value="2" <?php echo isset($schedule_type) && $schedule_type == 2 ? 'selected' : ''  ?>>Night Shift</option>
						</select>
					</div>
					<div class="form-group">
