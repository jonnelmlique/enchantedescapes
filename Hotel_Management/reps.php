...
$sql = "SELECT 
        ...
        FROM 
            checked c
        INNER JOIN
            payments p ON c.checkedid = p.checkedids
        WHERE 
...
if ($result && $result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $totalAmount = $row['room_total_price'] + $row['ordtotalamount'];
    ...
    echo "<tr><td colspan='14'>No payment records found</td></tr>";
}
?>
        </tbody>
        <tfoot>
            <tr>
                <th colspan="13">Total Sales (<?php echo date("F Y"); ?>):</th>
